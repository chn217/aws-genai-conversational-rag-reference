...
const baseFlags: FlagInput<BaseDocumentCommandFlags> = {
  profile: Flags.string({
    aliases: ['p'],
    description: 'The profile set up for you AWS CLI (associated with your AWS account)',
  }),
  region: Flags.string({
    aliases: ['r'],
...
export const documentUploadCommandFlags: FlagInput<DocumentUploadCommandFlags> = {
  ...
  language: Flags.string({
    description: 'The language of your documents',
  }),
  skipConfirmations: Flags.boolean({
    ...
    relationships: [
      {
        type: 'all',
        flags: ['profile', 'region', 'bucketName', 'uploadKeyPrefix', 'metadataFile'],
      },
    ],
  }),
};
